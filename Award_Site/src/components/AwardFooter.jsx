...
export default function AwardFooter() {
  ...
  return (
    <section
      ref={footerRef}
      className="inner-container px-20 bg-orange text-white mt-20 rounded-tl-4xl rounded-tr-4xl"
    >
      <div className="pt-24 grid grid-cols-12">
        ...
        <div className="col-span-2">
          <h3 className="text-4xl text-brown font-bold mb-4">Explore</h3>
        ...
        <div className="col-span-2">
          <h3 className="text-4xl text-brown font-bold mb-4">Experience</h3>
          <ul className="flex flex-col gap-3">
            <li>
              <a href="" className="hover:underline">
                Taste Journey
