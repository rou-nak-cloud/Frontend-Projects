export default function AwardFlavourCard({ setActiveFlavor }) {
  return (
    <>
      <div className="grid grid-cols-4 gap-5 items-end pb-30 mx-5 h-screen">
        <div
        ...
        >
          <p
            className="mt-6 text-white text-2xl text-center leading-6 opacity-0 
